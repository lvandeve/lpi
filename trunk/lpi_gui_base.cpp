...
const Pos<Sticky> STICKYTOPLEFT = { TOPLEFT, TOPLEFT, TOPLEFT, TOPLEFT };
const Pos<Sticky> STICKYTOPCENTER = { CENTER, TOPLEFT, CENTER, TOPLEFT };
const Pos<Sticky> STICKYTOPRIGHT = { BOTTOMRIGHT, TOPLEFT, BOTTOMRIGHT, TOPLEFT };
const Pos<Sticky> STICKYCENTERLEFT = { TOPLEFT, CENTER, TOPLEFT, CENTER };
const Pos<Sticky> STICKYCENTER = { CENTER, CENTER, CENTER, CENTER };
const Pos<Sticky> STICKYCENTERRIGHT = { BOTTOMRIGHT, CENTER, BOTTOMRIGHT, CENTER };
const Pos<Sticky> STICKYBOTTOMRIGHT = { BOTTOMRIGHT, BOTTOMRIGHT, BOTTOMRIGHT, BOTTOMRIGHT };
const Pos<Sticky> STICKYBOTTOMCENTER = { CENTER, BOTTOMRIGHT, CENTER, BOTTOMRIGHT };
const Pos<Sticky> STICKYBOTTOMLEFT = { TOPLEFT, BOTTOMRIGHT, TOPLEFT, BOTTOMRIGHT };
const Pos<Sticky> STICKYFULL = { TOPLEFT, TOPLEFT, BOTTOMRIGHT, BOTTOMRIGHT };
const Pos<Sticky> STICKYNOTHING = { NOTHING, NOTHING, NOTHING, NOTHING };
const Pos<Sticky> STICKYVERTICALLEFT = { TOPLEFT, TOPLEFT, TOPLEFT, BOTTOMRIGHT };
const Pos<Sticky> STICKYVERTICALCENTER = { CENTER, TOPLEFT, CENTER, BOTTOMRIGHT };
const Pos<Sticky> STICKYVERTICALRIGHT = { BOTTOMRIGHT, TOPLEFT, BOTTOMRIGHT, BOTTOMRIGHT };
const Pos<Sticky> STICKYHORIZONTALTOP = { TOPLEFT, TOPLEFT, BOTTOMRIGHT, TOPLEFT };
const Pos<Sticky> STICKYHORIZONTALCENTER = { TOPLEFT, CENTER, BOTTOMRIGHT, CENTER };
const Pos<Sticky> STICKYHORIZONTALBOTTOM = { TOPLEFT, BOTTOMRIGHT, BOTTOMRIGHT, BOTTOMRIGHT };
const Pos<Sticky> STICKYRELATIVE = { RELATIVE00, RELATIVE00, RELATIVE11, RELATIVE11 };
const Pos<Sticky> STICKYRELATIVE00 = { RELATIVE00, RELATIVE00, RELATIVE00, RELATIVE00 };
const Pos<Sticky> STICKYRELATIVE01 = { RELATIVE00, RELATIVE11, RELATIVE00, RELATIVE11 };
const Pos<Sticky> STICKYRELATIVE10 = { RELATIVE11, RELATIVE00, RELATIVE11, RELATIVE00 };
const Pos<Sticky> STICKYRELATIVE11 = { RELATIVE11, RELATIVE11, RELATIVE11, RELATIVE11 };
const Pos<Sticky> STICKYRELATIVEHORIZONTAL0 = { RELATIVE00, RELATIVE00, RELATIVE11, RELATIVE00 };
const Pos<Sticky> STICKYRELATIVEVERTICAL0 = { RELATIVE00, RELATIVE00, RELATIVE00, RELATIVE11 };
const Pos<Sticky> STICKYRELATIVEHORIZONTAL1 = { RELATIVE00, RELATIVE11, RELATIVE11, RELATIVE11 };
const Pos<Sticky> STICKYRELATIVEVERTICAL1 = { RELATIVE11, RELATIVE00, RELATIVE11, RELATIVE11 };
const Pos<Sticky> STICKYRELATIVEHORIZONTALFULL = { RELATIVE00, TOPLEFT, RELATIVE11, BOTTOMRIGHT };
const Pos<Sticky> STICKYRELATIVEVERTICALFULL = { TOPLEFT, RELATIVE00, BOTTOMRIGHT, RELATIVE11 };
const Pos<Sticky> STICKYRELATIVELEFT = { TOPLEFT, RELATIVE00, TOPLEFT, RELATIVE11 };
const Pos<Sticky> STICKYRELATIVETOP = { RELATIVE00, TOPLEFT, RELATIVE11, TOPLEFT };
const Pos<Sticky> STICKYRELATIVERIGHT = { BOTTOMRIGHT, RELATIVE00, BOTTOMRIGHT, RELATIVE11 };
const Pos<Sticky> STICKYRELATIVEBOTTOM = { RELATIVE00, BOTTOMRIGHT, RELATIVE11, BOTTOMRIGHT };

const Pos<Sticky> STICKY_SIDE0_SIDE0 = { TOPLEFT, TOPLEFT, TOPLEFT, TOPLEFT };
const Pos<Sticky> STICKY_SIDE0_SIDE1 = { TOPLEFT, BOTTOMRIGHT, TOPLEFT, BOTTOMRIGHT };
const Pos<Sticky> STICKY_SIDE1_SIDE0 = { BOTTOMRIGHT, TOPLEFT, BOTTOMRIGHT, TOPLEFT };
const Pos<Sticky> STICKY_SIDE1_SIDE1 = { BOTTOMRIGHT, BOTTOMRIGHT, BOTTOMRIGHT, BOTTOMRIGHT };
const Pos<Sticky> STICKY_FULL_CENTER = { TOPLEFT, CENTER, BOTTOMRIGHT, CENTER };
const Pos<Sticky> STICKY_SIDE0_CENTER = { TOPLEFT, CENTER, TOPLEFT, CENTER };
const Pos<Sticky> STICKY_SIDE1_CENTER = { BOTTOMRIGHT, CENTER, BOTTOMRIGHT, CENTER };
